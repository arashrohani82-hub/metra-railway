"""Metra branded ODS email signature with hosted logo."""
import html
import os
...
# Register only once.
if 'email_logo' not in ods.app.view_functions:
    ods.app.add_url_rule('/assets/metra-logo.png', 'email_logo', email_logo, methods=['GET'])


def email_body_html(body):
    """Render the ODS email with a clean Metra Consultation signature and logo."""
...
ods.logger.warning('ODS EMAIL BRANDING ACTIVE: LOGO + metraconsultation.ca signature')
